...
$data = [
        ...
        ['Tunasan', $mt, $ft, $Tunasan, $greatertunasan, $Tunasan1, $strayTunasan1, $Tunasan, $strayTunasan, null, $cat1tunasan, $cat2tunasan, $cat3tunasan, null, $tcvTunasan, $hrigTunasan, $erigTunasan],
        ...
        ['Putatan Main', $mpu, $fpu, $Putatan_Main22, $greaterPutatan_Main, $Putatan_Main1, $strayPutatan_Main1, $Putatan_Main, $strayPutatan_Main, null, $cat1Putatan_Main, $cat2Putatan_Main, $cat3Putatan_Main, null, $tcvPutatan_Main, $hrigPutatan_Main, $erigPutatan_Main],
        ['Putatan Annex', $mpua, $fpua, $Putatan_Annex22, $greaterPutatan_Annex, $Putatan_Annex1, $strayPutatan_Annex1, $Putatan_Annex, $strayPutatan_Annex, null, $cat1Putatan_Annex, $cat2Putatan_Annex, $cat3Putatan_Annex, null, $tcvPutatan_Annex, $hrigPutatan_Annex, $erigPutatan_Annex],
        ['Bayanan Main', $mba, $fba, $Bayanan_Main22, $greaterBayanan_Main, $Bayanan_Main1, $strayBayanan_Main1, $Bayanan_Main, $strayBayanan_Main, null, $cat1Bayanan_Main, $cat2Bayanan_Main, $cat3Bayanan_Main, null, $tcvBayanan_Main, $hrigBayanan_Main, $erigBayanan_Main],
        ['Bayanan Annex', $mbannex, $fbannex, $Bayanan_Annex22, $greaterBayanan_Annex, $Bayanan_Annex1, $strayBayanan_Annex1, $Bayanan_Annex, $strayBayanan_Annex, null, $cat1Bayanan_Annex, $cat2Bayanan_Annex, $cat3Bayanan_Annex, null, $tcvBayanan_Annex, $hrigBayanan_Annex, $erigBayanan_Annex],
        ['Alabang', $ma, $fa, $Alabang22, $greaterAlabang1, $Alabang1, $strayAlabang1, $Alabang, $strayAlabang, null, $cat1Alabang, $cat2Alabang, $cat3Alabang, null, $tcvAlabang, $hrigAlabang, $erigAlabang],
        ...
        ['Sucat', $msu, $fsu, $Sucat22, $greaterSucat, $Sucat1, $straySucat1, $Sucat, $straySucat, null, $cat1Sucat, $cat2Sucat, $cat3Sucat, null, $tcvSucat, $hrigSucat, $erigSucat],
        ['B.Silang', $msilang, $fsilang, $Bagong_Silang, $greaterBagong_Silang, $Bagong_Silang1, $Bagong_Silang11, $Bagong_Silang22, $strayBagong_Silang22, null, $cat1Bagong_Silang, $cat2Bagong_Silang, $cat3Bagong_Silang, null, $tcvBagong_Silang, $hrigBagong_Silang, $erigBagong_Silang],
        ['Sitio Sto. Niño', $mnino, $fnino, $Sitio22, $greaterSitio, $Sitio1, $straysitio1, $Sitio, $straysitio, null, $cat1sitio, $cat2sitio, $cat3sitio, null, $tcvtSitio, $hrigSitio, $erigSitio],
