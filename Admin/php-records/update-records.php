<?php   
        if(isset($_GET['idnew']) && isset($_GET['patientid'])){
        ...
        } elseif(isset($_GET['recordidnew']) && isset($_GET['appointid'])) {
            $recordid = $_GET['recordidnew'];
            ...
            if(!$res){
                ...
                header("Location: ../patient-details.php?appointID=$appointid&update=Update Succefully");
            }
