                    ...
                    <div class="box-table">
                        <div id="scroll">
                            <table>
                                ...
                                <tbody id="mytable">
                                <?php
                                    $sql = "select * from user_accounts where Access = 'Admin'";
                                    ...
                                    if(!empty($rows)){ 
                                        ...
                                        ?>
                                            <tr>
                                                <td><a href="v-admin.php?id=<?php echo $row['userID'] ?>" id="open-u"><?php echo $row['userID']?></a></td>
